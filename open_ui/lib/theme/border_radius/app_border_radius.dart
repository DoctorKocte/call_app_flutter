...
class AppBorderRadius {
  ...
  factory AppBorderRadius.regular() => const AppBorderRadius(
      ...
      radiusTop16: BorderRadius.vertical(top: Radius.circular(16)),
      radius18Top: BorderRadius.only(topLeft: Radius.circular(18), topRight: Radius.circular(18)),
  ...
  final BorderRadius radius18Top;
